...
<div class="space-y-6">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Create Package</h1>
        <p class="text-white/70">Add a new subscription package</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.packages.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" id="price" name="price" value="{{ old('price') }}" required class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]">
                ...
                <div>
                    ...
                    <input type="number" id="duration_days" name="duration_days" value="{{ old('duration_days') }}" required min="1" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]">
                </div>

                <div class="md:col-span-2">
                    <label for="description" class="block text-sm font-medium text-white/90 mb-2">Description</label>
                    <textarea id="description" name="description" rows="3" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]">{{ old('description') }}</textarea>
                </div>
                    ...
                    <div class="space-y-4 border border-white/10 rounded-lg p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="feature_instances_limit" name="feature_instances_limit" value="{{ old('feature_instances_limit', '') }}" min="-1" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]" placeholder="-1 for unlimited">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="feature_messages_limit" name="feature_messages_limit" value="{{ old('feature_messages_limit', '') }}" min="-1" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]" placeholder="-1 for unlimited">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="feature_api_calls_limit" name="feature_api_calls_limit" value="{{ old('feature_api_calls_limit', '') }}" min="-1" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]" placeholder="-1 for unlimited">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="feature_api_keys_limit" name="feature_api_keys_limit" value="{{ old('feature_api_keys_limit', '') }}" min="-1" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]" placeholder="-1 for unlimited">
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="h-4 w-4 text-[#FCD535] focus:ring-[#FCD535] border-white/20 rounded bg-[#1A1A1A]">
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', 0) }}" class="w-full px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#FCD535]">
                </div>
            </div>

            <div class="flex items-center space-x-3 pt-4 border-t border-white/5">
                <x-button type="submit" variant="primary" size="md">Create Package</x-button>
